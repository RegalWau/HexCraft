...
public class NEI_CrystalSeparator extends TemplateRecipeHandler {
    ...
    public NEI_CrystalSeparator(HashMap<ItemStack, ItemStack> hashMap) {
        this.hashMap = hashMap;
        transferRects.add(new RecipeTransferRect(new Rectangle(71-sOffsetX, 28-sOffsetY, 34, 22), getOverlayIdentifier()));
    ...
    public TemplateRecipeHandler newInstance() {
        return new NEI_CrystalSeparator(hashMap);
    }
    ...
    public String getOverlayIdentifier() {
        return HexCraft.MODID + "." + TileCrystalSeparator.ID;
    }
    ...
    public String getRecipeName() {
        return LanguageRegistry.instance().getStringLocalization(TileCrystalSeparator.INVENTORY_NAME);
    }

    @Override
    public String getGuiTexture() {
        return HexCraft.MODID + ":textures/gui/nei/neiCrystalSeparator.png";
    }

    @Override
    public void drawExtras(int aRecipeIndex) {
        drawText(I18n.format(GUI_STRING_IN) + ":", 106 - getTextWidth(I18n.format(GUI_STRING_IN) + ":"), GUI_SIZE_Y - 110, 0x404040);
        String out = TileCrystalSeparator.ENERGY_PER_TICK + " HEX/t";
